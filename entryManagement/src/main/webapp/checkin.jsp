...
<center>
    ...
    <div align="center" style="margin-top: 50px;">
        ...
        <form method="post" action="checkin">
            ...
            <input type="tel" name="mobileNumber" placeholder="Phone Number" size="35"
                   STYLE="color: #FFFFFF; background-color: rgb(114, 196, 210);" size="30" maxlength="30"><br><br>

            <h2> Host's information:</legend> </h2><br>
            <input type="text" name="hostName" placeholder="Name" size="35"
                   STYLE="color: #FFFFFF; background-color: rgb(114, 196, 210);" size="30" maxlength="30"><br><br>
            <input type="email" name="hostemail" placeholder="Email address" size="35"
                   STYLE="color: #FFFFFF; background-color: rgb(114, 196, 210);" size="30" maxlength="30"><br><br>
            <input type="tel" name="hostMobileNumber" placeholder="Phone Number"
                   size="35" STYLE="color: #FFFFFF; background-color: rgb(114, 196, 210);" size="30" maxlength="30"><br><br>
            <br>
